...
import profileImage from '../assets/react.svg'; // Asegúrate de importar tu imagen correctamente
...
const Header = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-[1024px] bg-col-zinc py-4 px-4 md:px-6 z-50">
